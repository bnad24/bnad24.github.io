    ...
    <div>
      ...
      <div style={{ marginBottom: '1rem' }}>
        <details>
          ...
          <p>
            {`В дополнение к нашей страничке со статистикой, мы решили также "скопировать" адреса штабов чтобы сделать жту информацию более доступной. Адреса автоматически считываеются со `}
          ...
          <p>
            {
              'Мы не контролируем информацию об адресах и не можем её проверить, а просто копируем её в автоматическом режиме с официального сайта. Проверяйте, звоните, спрашивайте в Telegram, и будьте осторожны!'
            }
          </p>
